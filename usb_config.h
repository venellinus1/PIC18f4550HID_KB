...
/* CDC */
//config and data endpoints sharing same interface
#define CDC_COMM_INTF_ID        0x00 //config interface ID
#define CDC_COMM_EP              2
#define CDC_COMM_IN_EP_SIZE      8

#define CDC_DATA_INTF_ID        0x00 //CDC data endpoints interface ID
