...
/* Device Descriptor */
     ...
     ROM BYTE configDescriptor1[]={
         ...
         83,0x00,                    // Total length of data for this cfg
    	...
    	0x00,                       //Interval
         ...
         HID_INTF,                     // Class code
         BOOT_INTF_SUBCLASS,// 0,      // Subclass code
         HID_PROTOCOL_KEYBOARD, //0,   // Protocol code
         0,                            // Interface string index         
		 //*******************************************************************
         ...
         0x07,                         //sizeof(USB_EP_DSC)
         USB_DESCRIPTOR_ENDPOINT,      //Endpoint Descriptor
         _EP_OUT | HID_EP,             //EndpointAddress
         _INT,                   //Attributes
         /*0x40*/8,0x00,               //size
         0x01                          //Interval
     };
